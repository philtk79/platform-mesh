...
type IdPRegistrationStatus struct {
	...
	// OrganizationID is the linked Keycloak organization when email domain routing is configured.
	OrganizationID string `json:"organizationId,omitempty"`
	// LinkedEmailDomains lists normalized domains currently linked to the broker organization.
